      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Our autonomous metal working platform. Four-legged-wheeled design with 250+kg payload for heavy-duty precision metalworking in complex environments.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <CardContent className="p-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <h3 className="text-3xl font-bold mb-4">Centaur Metal Working Platform</h3>
          ...
          {/* Terrier Product */}
          <Card className="bg-gradient-to-br from-card to-muted/20 border-border overflow-hidden mt-8">
            <CardContent className="p-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <div className="space-y-4 mb-6">
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 rounded-full bg-primary"></div>
                      <span>Autonomous navigation and inspection capabilities</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 rounded-full bg-primary"></div>
                      <span>Advanced sensor suite for environmental mapping</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 rounded-full bg-primary"></div>
                      <span>Rugged design for challenging terrain</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 rounded-full bg-primary"></div>
                      <span>Real-time data collection and transmission</span>
                    </div>
                  </div>
                  
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Button size="lg" className="bg-secondary hover:bg-secondary/90 text-secondary-foreground">
                      Order Terrier <ExternalLink className="ml-2 h-4 w-4" />
                    </Button>
                    <Button variant="outline" size="lg" className="border-border hover:bg-muted">
                      <Download className="mr-2 h-4 w-4" />
                      View Datasheet
